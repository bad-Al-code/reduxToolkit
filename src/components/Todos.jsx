...
function Todos() {
  ...
  return (
    <>
      <div className="p-2 m-4 bg-slate-100 shadow-md rounded-lg ">
              ...
              <div>
                {editTodoId === todo.id ? (
                  <button
                    ...
                    className="text-white bg-green-500 border-0 py-1 px-4 focus:outline-none hover:bg-green-600 rounded text-md align-top"
                  >
                    Save
                  </button>
                ) : (
